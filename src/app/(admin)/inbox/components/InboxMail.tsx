                ...
                <li className="email-read-done" key={idx}>
                  <div className="d-flex flex-column h-100 border-bottom">
                    <Link href="" className="d-block">
                      <div
                        className={`mail-select d-flex align-items-center p-3 ${idx == 1 && "selected"}  m-1 rounded`}
                      >
                        <div className="position-relative">
                          <Image
                            src={item.avatar}
                        ...
                        <div className="d-block ms-3 flex-grow-1">
                          <div className="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <div>
                              <p
                                className={` fs-13 mb-0 ${idx == 1 ? "text-white" : "text-muted"}`}
                              >
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <p
                              className={`mb-0  d-flex align-items-center gap-1 ${idx == 1 ? "text-white" : "text-muted"}`}
                            >
                              {item.emailMessage}
                            </p>
                          </div>
